...
final class GwsLogger {
     ...
     * @return
     */
    static Logger getLogger(GwsLoggerTypeEnum loggerType){
     ...
     * @param args
     */
    static void info(GwsLoggerTypeEnum loggerType,String msg, Object... args){
     ...
     * @param args
     */
    static void info(GwsLoggerTypeEnum loggerType,Throwable throwable, String msg, Object... args) {
        Logger logger = getLogger(loggerType)
     ...
     * @param args
     */
    static void info(Throwable throwable, String msg, Object... args) {
        Logger logger = getLogger()
        msg = addImportantToLog(format(msg,args))
        logger.info(msg, throwable)
    }
     ...
     * @param args
     */
    static void debug(Throwable throwable, String msg, Object... args){
        Logger logger = getLogger()
        msg = addImportantToLog(format(msg,args))
     ...
     * @param args
     */
    static void error(Throwable throwable, String msg, Object... args){
        Logger logger = getLogger()
        msg = addImportantToLog(format(msg,args))
        logger.debug(msg, throwable)
    }
